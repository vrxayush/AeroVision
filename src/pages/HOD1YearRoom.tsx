...
export default function HOD1YearRoom() {
  ...
  const generateNewCode = () => {
    ...
    result += "= hod.1yr@aerowatch";
    setSshCode(result);
  };

  // Mock Data for Logs - HOD 1st Year Specific
  const entryLogs = [
    { id: 1, entry: "08:45:00 AM", exit: "11:00:00 AM", date: "2025-10-27" },
    { id: 2, entry: "01:30:00 PM", exit: "03:15:00 PM", date: "2025-10-27" },
    { id: 3, entry: "09:15:00 AM", exit: "04:45:00 PM", date: "2025-10-26" },
  ];

  const accessLogs = [
    { id: 1, ip: "192.168.3.12", device: "HOD 1st Yr Laptop", time: "08:50:33 AM", user: "HOD 1st Year", browser: "Safari 16" },
    { id: 2, ip: "192.168.3.20", device: "Coordinator PC", time: "10:10:00 AM", user: "Year Coordinator", browser: "Chrome 118" },
    { id: 3, ip: "10.0.3.8", device: "Exam Cell PC", time: "01:45:22 PM", user: "Exam Officer", browser: "Firefox 119" },
  ];
      ...
      <div className="relative z-10 max-w-6xl mx-auto flex flex-col gap-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground tracking-tight flex items-center gap-2">
                ...
                <ModernText text="HOD 1st Year Room Surveillance" />
              </h1>
              <p className="text-muted-foreground">First Year Department Control</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <ModernCard className="overflow-hidden border-orange-500/20 shadow-lg shadow-orange-500/5">
              <div className="aspect-video bg-black relative flex items-center justify-center group">
                ...
                <div className="text-center space-y-4">
                    ...
                    <p className="text-white/40 text-sm font-mono">LIVE FEED • CAM-04 • 1ST YEAR BLOCK</p>
                </div>
             ...
             <ModernCard className="p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="p-4 rounded-lg bg-secondary/50 border border-border/50">
                        ...
                        <div className="font-bold text-lg">07:00 AM</div>
                    </div>
                </div>
            </ModernCard>
          </div>
                    ...
                    <Dialog>
                        <DialogTrigger asChild>
                            <ModernButton className="w-full h-14 text-lg justify-between group" variant="outline">
                                ...
                                <div className="bg-orange-500/10 text-orange-500 px-2 py-1 rounded text-xs font-bold group-hover:bg-orange-500 group-hover:text-white transition-colors">
                                    VIEW
                                </div>
                            </ModernButton>
                        </DialogTrigger>
                        <DialogContent className="max-w-2xl max-h-[80vh] flex flex-col">
                            <DialogHeader>
                                <DialogTitle className="flex items-center gap-2">
                                    ...
                                    HOD 1st Year Office Access Logs
                                </DialogTitle>
                                <DialogDescription>
                                        ...
                                        <div className="space-y-4">
                                            {accessLogs.map((log) => (
                                                <div key={log.id} className="flex flex-col gap-2 p-4 rounded-lg border border-border bg-card/50 hover:bg-accent/50 transition-colors">
                                                    ...
                                                    <div className="text-xs text-orange-500 font-medium px-1">
                                                        User: {log.user}
                                                    </div>
                                                </div>
                                            ))}
