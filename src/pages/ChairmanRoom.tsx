...
import { ArrowLeft, ShieldCheck, Clock, Monitor, Globe, Lock, History, AlertCircle, Key, Copy, RefreshCw } from "lucide-react";
...
export default function ChairmanRoom() {
  ...
  const generateNewCode = () => {
    ...
    result += "= admin@aerowatch";
    setSshCode(result);
  };

  // Mock Data for Logs
  const entryLogs = [
    { id: 1, entry: "09:00:15 AM", exit: "11:30:00 AM", date: "2025-10-27" },
    { id: 2, entry: "01:15:22 PM", exit: "01:45:10 PM", date: "2025-10-27" },
    { id: 3, entry: "06:00:05 PM", exit: "06:10:00 PM", date: "2025-10-26" },
  ];

  const accessLogs = [
    { id: 1, ip: "192.168.1.45", device: "Admin MacBook Pro", time: "10:05:22 AM", user: "Admin User", browser: "Chrome 118" },
    { id: 2, ip: "10.0.0.12", device: "Security Station 1", time: "09:00:00 AM", user: "Guard A", browser: "Firefox 119" },
    { id: 3, ip: "172.16.0.5", device: "Director iPad", time: "08:45:11 AM", user: "Director", browser: "Safari Mobile" },
  ];

  return (
    <div className="min-h-screen bg-background relative overflow-hidden selection:bg-primary/20 p-8">
      {/* Background Elements */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px]" />
      <div className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] bg-purple-500/5 rounded-full blur-3xl animate-pulse" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto flex flex-col gap-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground tracking-tight flex items-center gap-2">
                ...
                <ModernText text="Chairman Room Surveillance" />
              </h1>
              <p className="text-muted-foreground">Secure Feed & Access Control</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <ModernCard className="overflow-hidden border-purple-500/20 shadow-lg shadow-purple-500/5">
              <div className="aspect-video bg-black relative flex items-center justify-center group">
                ...
                <div className="text-center space-y-4">
                    ...
                    <p className="text-white/40 text-sm font-mono">LIVE FEED • CAM-01 • SECURE</p>
                </div>
             ...
             <ModernCard className="p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="p-4 rounded-lg bg-secondary/50 border border-border/50">
                        ...
                        <div className="font-bold text-lg">Empty</div>
                    </div>
                    <div className="p-4 rounded-lg bg-secondary/50 border border-border/50">
                    ...
                    <Dialog>
                        <DialogTrigger asChild>
                            <ModernButton className="w-full h-14 text-lg justify-between group" variant="outline">
                                ...
                                <div className="bg-purple-500/10 text-purple-500 px-2 py-1 rounded text-xs font-bold group-hover:bg-purple-500 group-hover:text-white transition-colors">
                                    VIEW
                                </div>
                            </ModernButton>
                        </DialogTrigger>
